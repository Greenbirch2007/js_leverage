...
def savedt():
    ...
    sql_sp_LJ = 'select {} from js225_400_leverage_2022_0321  ; '
    ...
    sql_sp_f = 'select {0} from js225_400_leverage_2022_0321  ; '
    df_js_f = pd.read_sql_query(sql_sp_f.format(",".join(get_code)), engine_jsMons)
    df_js_f.to_excel("js225_400_leverage_2022_0321.xlsx")
